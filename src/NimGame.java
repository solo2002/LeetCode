...
Hint:
    ...
    If there are 5 stones in the heap, could you figure out a way to remove the stones such that you
     will always be the winner?

 */
public class NimGame {
	public static boolean canWinNim(int n)
	{//every time pick the (4a + 1)st stone
		//for instance, 1, 5, 9, 13, 17, 21, 25...
		//4a+1, 4a+1+1, 4a+1+2 all could win. Only 4a will lose
		return !(n%4 == 0);
	}
}
